...
const config = {
  url: process.env.DS_NORTHSTAR_API_OAUTH_TOKEN_HOST,
  clientId: process.env.DS_NORTHSTAR_API_OAUTH_CLIENT_ID,
  clientSecret: process.env.DS_NORTHSTAR_API_OAUTH_CLIENT_SECRET,
